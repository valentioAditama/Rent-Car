  ...
  <div class="row d-flex justify-content-between">
    <form class="form-inline" action="{{route('index.customer.search')}}" method="get">
      <div class="form-group mx-sm-3 mb-2">
        <input type="text" class="form-control w-100" name="search" id="search" value="{{$search}}" placeholder="Search Model">
      </div>
  ...
  <div class="row mt-4 mb-3 ">
    ...
    <div class="col-md-4">
      <div class="card" style="width: 30rem;">
        <img src="{{ asset('storage/owner-cars/' . $datas->pitcure1) }}" class="card-img-top img-fluid" alt="...">
        <div class="card-body">
